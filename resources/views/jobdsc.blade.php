      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <button class="btn btn-light rounded-pill" type="button" style="margin-left: 870px; ">Sign In</button>
            </li>
            <li class="nav-item">
              <button class="btn btn-light rounded-pill" type="button" style="margin-left: 10px;">Sign Up</button>
            </li>
          </ul>
        </div>
      </div>
      ...
      <table class="table" style="border-collapse: separate; border-spacing: 10px;">
        <tr>
          <td style="width: 100%; border: 1px solid #ccc; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">
            ...
            <form action="/upload" method="POST" enctype="multipart/form-data" style="margin : 10px 5px 5px 25px;" style="color:#b12121 ;">
